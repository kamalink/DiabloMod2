    ...
    portals_vp: {
        content: `
            <p>🔹 <b>Стоимость входа:</b> 💰 х2.5 от НП 
                ...
                <label style="margin-left: 5px; font-size: 0.8rem; color: #d4af37; cursor: pointer;"><input type="checkbox" id="vp-solo-check"> Соло</label>
                <input id="vp-level-input" type="number" placeholder="Ур. >75" style="width: 60px; display:none; margin-left: 5px; padding: 2px; background: #000; color: #fff; border: 1px solid #444; text-align: center;">
            </p>
    ...
    death_rules: {
        content: `
            ...
            <div style="border: 2px solid #ff4444; padding: 15px; background: rgba(255, 68, 68, 0.05); border-radius: 8px;">
                ...
                <p>🔹 <b>Навыки:</b> 5% шанс забыть каждый изученный навык.</p>
            </div>
